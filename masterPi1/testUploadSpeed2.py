...
class myProtocol(protocol.Protocol):
	...
	def connectionMade(self):
		...
		os.system('echo {0} | mail -s "Pi1 IP Address" msit@wellesley.edu'.format(ip_address))
		msg = "ip piGroup1 slavePi1"
		print msg
	...
	def dataReceived(self, data):
		...
		if msgFromServer[1] == "startProgram":
			...
			self.transport.write("respondingToLostPiPing piGroup1 slavePi1")
		else:
