...
#Comparable in time to picThread2.py.  Runs very slowly (~24 seconds for 25 pictures).  Uses two threads to take pictures
#and move/remove files to the masterPi.  Move/removing logic is different from picThread2.
