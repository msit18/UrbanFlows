...
#First iteration of picThread series.  Comparable in times to picThread4 and may possibly be faster.
#Logic in this file vs picThread4 in collecting and moving files is different.
