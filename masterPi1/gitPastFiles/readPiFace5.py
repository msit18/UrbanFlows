...
class callAll():
	...
	def init(self):
		...
		global totalTime, totalTimeEng, videoTime, videoTimeEng, resolutionW, resolutionH, numFrames, timeInterval, timeIntervalEng, inputFR
	...
	def homeScreen(self):
		...
		if p1.currentMode == "VID":
			...
			cad.lcd.write("{0} TT{1}\n{2} Res:{3}p".format(p1.currentMode, p1.totalTimeEng, p1.inputFR, p1.resolutionH))
