...
#TODO: Figure out if I need to have all the get methods. Could I just use self.(var)?
...
class MasterVariables():
	...
	def checkIfTimeIsValid(self):
		while True:
			...
			try:
				userInputTime = datetime.datetime.strptime(self.getStartTime(), "%x %X")
