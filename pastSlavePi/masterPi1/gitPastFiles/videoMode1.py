...
#					print ("10.0.0.5: " + str(k))
#					os.system("sshpass -p 'raspberry' ssh pi@10.0.0.1 python flash.py {0}".format(str(k)))
...
#					print (list)
				...
				os.system("sshpass -p 'raspberry' ssh pi@10.0.0.1 -o StrictHostKeyChecking=no python flash.py fin {0} {1} {2} {3} {4}".format(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5]))
				break
