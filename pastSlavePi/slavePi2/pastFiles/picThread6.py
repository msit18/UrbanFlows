...
#Executes faster than picThread2 or picThread6 (runs ~6.5 seconds for 25 pictures).  Takes pictures on one thread
#and moves/removes them to the MasterPi on a second thread by sending multiple pictures at once
