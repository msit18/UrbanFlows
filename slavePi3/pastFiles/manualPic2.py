...
#Edited from manualPic.py to take arguments from readPiFace.py.  Takes pictures on one thread and on another thread
...
#					print 'Captured {0} frames at {1}fps in {2}secs'.format( str(numPics), str(numPics/(finish-start)), str(finish-start))
			...
			print "10.3: Captured {0} total pictures at an average of {1} fps in an average of {2} secs.  Total time was {3}, total FPS is {4}"\
