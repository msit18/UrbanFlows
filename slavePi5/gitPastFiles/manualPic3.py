	...
	def run (self):
		...
		while True:
			...
			if runThread is 'beginT2':
				...
				os.system("sshpass -p 'raspberry' ssh pi@10.0.0.1 -o StrictHostKeyChecking=0 python flash.py fin {0} {1} {2} {3}".format(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]) )
				break
